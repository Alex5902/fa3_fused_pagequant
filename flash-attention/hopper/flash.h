...
struct Flash_fwd_params : public Qkv_params {
    ...
    void *kq_ptr = nullptr;
    void *vq_ptr = nullptr;
    void *k_scales_ptr = nullptr;
    void *v_scales_ptr = nullptr;
    void *k_zps_ptr = nullptr;
    void *v_zps_ptr = nullptr;

    int64_t kq_row_stride=0, kq_head_stride=0, kq_batch_stride=0;
    int64_t vq_row_stride=0, vq_head_stride=0, vq_batch_stride=0;
